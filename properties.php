    ...
    <div class="container footer-top-grid">
      ...
      <div class="footer-col-contact">
        ...
        <div class="footer-social-links">
          <a href="https://www.facebook.com/share/19HddagvwY/" class="social-icon magnetic" target="_blank" rel="noopener" aria-label="Facebook"><i class="fa-brands fa-facebook-f"></i></a>
